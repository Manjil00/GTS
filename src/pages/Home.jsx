...
<div className='MainContainer h-auto w-full bg-Beigebg'>
    ...
    <div className="Section1 h-[350px] md:h-[600px] w-full relative">
        ...
        <div className='cards h-[130px] w-[190px] bg-green-800 rounded-xl p-3'>
                <h1 className='text-center mt-2 text-sm md:text-2xl'>100+</h1>
                <p className='text-center mt-3 break-words text-xs md:text-xl'>qwertiueyruwecxcsdcscsdcdsccrda</p>
        </div>

        <div className='cards2 h-[130px] w-[190px] bg-green-800 rounded-xl p-3'>
                <h1 className='text-center mt-2 text-sm md:text-2xl'>100+</h1>
                <p className='text-center mt-3 break-words text-xs md:text-xl'>qwertiueyruwecxcsdcscsdcdsccrda</p>
        </div>

        <div className='cards3 h-[130px] w-[190px] bg-green-800 rounded-xl p-3'>
                <h1 className='text-center mt-2 text-sm md:text-2xl'>100+</h1>
                <p className='text-center mt-3 break-words text-xs md:text-xl'>qwertiueyruwecxcsdcscsdcdsccrda</p>
        </div>
