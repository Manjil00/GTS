...
<div className='MainContainer h-auto w-full bg-Beigebg'>
    ...
    <div className="Section1 h-[350px] md:h-[600px] w-full relative">
        ...
        <div className="texts text-white absolute top-[100px] left-[300px]  ml-2 mt-12 md:mt-14 md:ml-10 flex justify-between items-center gap-[20px] md:gap-[300px]">
    ...
    <div className="countups flex justify-center items-center gap-5 absolute bottom-0 inset-x-6">
        <div className='cards h-[100px] w-[100px] md:h-[130px] md:w-[190px] bg-blue-600  rounded-xl p-3'>
        ...
        <div className='cards2 h-[100px] w-[100px] md:h-[130px] md:w-[190px] bg-blue-600 rounded-xl p-3'>
                <h1 className='text-center md:mt-2 text-xl md:text-4xl font-bold'>
                <CountUp end={25} duration={6}></CountUp>+</h1>
                <p className='text-center mt-3 break-words text-xs md:text-xl'>qwertiueyruwecx</p>
        </div>
        <div className='cards3 h-[100px] w-[100px] md:h-[130px] md:w-[190px] bg-blue-600 rounded-xl p-3'>
                <h1 className='text-center md:mt-2 text-xl md:text-4xl font-bold'>
                <CountUp end={25} duration={6}></CountUp>+</h1>
    ...
    {/* //SECTION2 */}
    <div className="Section2 h-[500px] w-full">
