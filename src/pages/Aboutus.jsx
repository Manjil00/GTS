...
const Aboutus = () => {
  ...
  return (
    <div className='Main_aboutus bg-Gts_white text-appleblack w-full h-auto'>
      ...
      <h1 className='font-titleFont text-2xl md:text-4xl text-appleblack '><span className='text-blue-700'>ABOUT</span> US</h1>
      ...
      <h1 className='font-titleFont text-2xl md:text-4xl text-center text-appleblack'><span className='text-blue-700'>Our</span> Mission</h1>
      ...
      <div className="circlemissions flex flex-col md:flex-row justify-center items-center gap-5 mt-5" data-aos="fade-up">
      ...
      <h1 className='font-titleFont text-2xl md:text-4xl text-center mt-5 text-appleblack'>Minds Behind the Magic</h1>
