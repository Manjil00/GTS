...
return (
        ...
        <div className='cards h-[100px] w-[100px] md:h-[130px] md:w-[190px] bg-Gts_blue cursor-pointer hover:bg-black  rounded-xl p-3'>
        ...
        <div className='cards2 h-[100px] w-[100px] md:h-[130px] md:w-[190px] bg-Gts_blue cursor-pointer hover:bg-black  rounded-xl p-3'>
                <h1 className='text-center md:mt-2 text-xl md:text-4xl font-bold text-white'>
        ...
        <div className='cards3 h-[100px] w-[100px] md:h-[130px] md:w-[190px] bg-Gts_blue cursor-pointer hover:bg-black rounded-xl p-3'>
                <h1 className='text-center md:mt-2 text-xl md:text-4xl font-bold text-white'>
                <CountUp end={25} duration={6}></CountUp>+</h1>
